...
<div class="modal" id="documentos-modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content" style="border: 2px solid #9370DB; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            ...
            <form action="documentosvarios_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                ...
                <input name="vcod_doc_var" value="0" type="hidden" />
                <input type="text" name="cod_ficha" value="<?= $_GET['vcod_ficha'] ?>" hidden>
                <div class="box-body">
                    <?php
                    ...
                    <div class="col-md-6">
                        <label for="vcod_t_docum">Tipo de Documento:</label>
                        <?php
                        $tipodocumentos = consultas::get_datos("SELECT * FROM tipo_documento ORDER BY cod_t_docum");
                        ?>
                        <select class="form-control" name="vcod_t_docum" required id="vcod_t_docum">
                            <option value="0">Seleccionar Tipo de Documento</option>
                            <?php foreach ($tipodocumentos as $tipodo) : ?>
                                <option value="<?php echo $tipodo['cod_t_docum']; ?>"><?php echo $tipodo['descrip_t_docum']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-12">
                        <label for="vobservacion_docvar">Observación:</label>
                        <input type="text" value="SIN OBSERVACION" class="form-control" name="vobservacion_docvar" id="vobservacion_docvar">
                    </div>
                </div>
                ...
                if (!empty($detallepatologias)) {
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-condensed table-hover" style="border-color: #9370DB;">
                            ...
                            <tbody>
                                <?php foreach ($detallepatologias as $detalles) { ?>
                                    <tr>
                                        ...
                                        <td data-title="Doctor"><?php echo $detalles['fecha_emision']; ?></td>
                                        <td data-title="Doctor"><?php echo $detalles['tipo_documento']; ?></td>
                                        <td data-title="Especialidad"><?php echo $detalles['observacion_docvar']; ?></td>
                                    </tr> 
                                <?php } ?>
                            </tbody>
                        </table>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary pull-right" style="background-color: #9370DB; border-color: #9370DB;">
