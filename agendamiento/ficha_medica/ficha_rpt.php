                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php } ?>
                            <div class="col-lg-12">
                                    <h3 class="page-header text-center"><strong>REPORTE FICHA MÉDICA</strong>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            ?>
                                            <form action="fichamedica_print.php" method="get" accept-charset="utf-8" class="form-horizontal" target="print">
                                                ...
                                                <div class="box-body">
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    <a href="ficha_rpt.php?opcion=1" class="list-group-item">Por Fechas</a>
                                                                    <a href="ficha_rpt.php?opcion=2" class="list-group-item">Por Paciente</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8 col-sm-8 col-lg-8">
                                                        <div class="panel panel-default">
                                                            ...
                                                            $pacientes = consultas::get_datos("SELECT * FROM v_pacientes WHERE cod_pacientes IN (SELECT cod_pacientes FROM ficha_medica)");
                                                            ?>
