                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <?php } ?>
                            <div class="col-lg-12">
                                    <h3 class="page-header text-center"><strong>AVISOS RECORDATORIOS</strong>
                                    <a href="/tdp/MANUAL DE USUARIO tdp.pdf" target="print">
                                    <span class="glyphicon glyphicon-question-sign"></span>
                                </a>
                                        <a href="avisos_add.php" class="btn btn-purple btn-sm pull-right" data-title="Agregar" rel="tooltip">
                                            <i class="fa fa-plus"></i> Agregar Avisos
                                        </a>
                                        <a href="avisos_print.php" class="btn btn-default btn-sm pull-right" data-title="Imprimir" rel="tooltip">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php
                                           $avisos = consultas::get_datos("SELECT * FROM v_avisos_recordatorios WHERE aviso_estado ILIKE '%%' ORDER BY cod_avisos;");
                                                ...
                                                <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered table-striped table-condensed">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($avisos as $aviso) { ?>
                                                            <tr>
                                                                <td data-title="#"><?php echo $aviso['cod_avisos']; ?></td>
                                                                ...
                                                                <td data-title="Acciones" class="text-center">
                                                                    <?php if ($aviso['aviso_estado'] == 'PENDIENTE') { ?>
                                                                     <a href="avisos_add.php?vrec_cod=<?php echo $aviso['cod_avisos']; ?>" 
                                                                    ...
                                                                    <a href="https://api.whatsapp.com/send?phone=NUMERO_TELEFONO&text=Hola *<?= $aviso['paciente']; ?>*, en fecha <?= $aviso['recor_fecha']; ?> desde las *<?= $aviso['cita_hora']; ?>*
                                                                       , tenías una cita con el Doctor <?= $aviso['doctor']; ?>* , lamento informar que el Doctor no atenderá ese día. Si deseas reagendar la cita para mayores consultas, comunícate con nosotros *" target="_blank" class="btn btn-success btn-sm">
                                                                        <i class="fa fa-commenting" aria-hidden="true"></i> WhatsApp
                                                                    </a>
                                                                    <a href="avisos_edit.php?vrec_cod=<?php echo $aviso['cod_avisos']; ?>" class="btn btn-warning btn-sm" role="button" data-title="Editar" 
                                                                       rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-edit"></span></a>

                                                                    <a onclick="anular(<?php echo "'" . $aviso['cod_avisos'] . "_" . $aviso['paciente'] . "_" . $aviso['recor_fecha'] . "'"; ?>)"
