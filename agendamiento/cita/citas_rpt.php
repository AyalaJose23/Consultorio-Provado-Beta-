                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-lg-8">
                                                        <div class="panel panel-default">
                                                            ...
                                                            $pacientes = consultas::get_datos("SELECT * FROM v_pacientes WHERE cod_pacientes IN (SELECT cod_pacientes FROM citas)");
                                                            ?>
                                                            ...
                                                            break;
                                                                    case 3:
                                                                        $pacientes = consultas::get_datos("select * from especialidad where cod_especialidad in(select cod_especialidad from citas)");
                                                                        ?>
                                                                        <div class="form-group">
                                                                            <label class="control-label col-lg-2 col-md-2 col-sm-2">Especialidad:</label>
                                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                                <select class="form-control select2" name="vcod_especialidad" required="">
                                                                                    <?php foreach ($pacientes as $pac) { ?>
