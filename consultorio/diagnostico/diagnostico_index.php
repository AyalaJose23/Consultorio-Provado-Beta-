...
<html>
    ...
    <body class="hold-transition skin-purple sidebar-mini">
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <?php } ?>
                            <div class="col-lg-12">
                                    <h3 class="page-header text-center"><strong>DIAGNOSTICO</strong>
                                    <a href="/taller3/MANUAL DE USUARIO tdp.pdf" target="print">
                                    <span class="glyphicon glyphicon-question-sign"></span>
                                </a>
                                <a href="diagnostico_add.php" class="btn btn-purple btn-sm pull-right" data-title="Agregar" rel="tooltip"> 
                                        <i class="fa fa-plus">  </i> AGREGAR DIAGNOSTICO
                                    </a>
                                            <a href="diagnostico_print.php" class="btn btn-default btn-sm pull-right" data-title="Imprimir" rel="tooltip"
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-info">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <?php
                                            $diagnostico = consultas::get_datos("SELECT * FROM v_diagnostico WHERE fecha_diag::text ILIKE '%%' ORDER BY cod_diag desc;");
                                                    ...
                                                    <?php foreach ($diagnostico as $diag) { ?>
                                                        <tr>
                                                            ...
                                                            <td data-title="Acciones" class="text-center">
                                                                <?php if ($diag['estado_diag'] == 'PENDIENTE') { ?>
                                                                    
                                                                    <a href="diagnosticodetalle_add.php?vcod_diag=<?php echo $diag['cod_diag']; ?>" 
                                                                       class="btn btn-success btn-sm" role="button" data-title="Detalles" 
                                                                       rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-list"></span></a>  
                                                                    
                                                                    <a onclick="anular(<?php echo "'".$diag['cod_diag']."_".$diag['paciente']."_".$diag['fecha_diag']."'";?>)"
                                                                ...
                                                                <?php } ?>
                                                                <a href="citas_print.php?vcita_cod=<?php echo $diag['cod_diag']; ?>" class="btn btn-primary btn-sm" role="button" data-title="Imprimir" 
        ...
        function anular(datos){
            ...
            $('#si').attr('href','diagnostico_control.php?vcod_diag='+dat[0]+'&accion=4');
         ...
         function confirmar(datos){
            var dat = datos.split('_');
            $('#sic').attr('href','diagnostico_control.php?vcod_diag='+dat[0]+'&accion=3');
